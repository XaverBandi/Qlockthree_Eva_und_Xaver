...
LedDriverDefault ledDriver(10, 12, 11, 3, 13);
...
void setup()
{
  ...
  // wir brauchen nur 13 Zeilen...
  ledDriver.setLinesToWrite(13);
  ...
  if (needsUpdateFromRtc)
  {
    ...
    switch (mode) {
      ...
      case EXT_MODE_TIMESET:
          ...
          //randomSeed((rtc.getMinutes() * 23) + (rtc.getHours() * 19) + (rtc.getDayOfWeek() * 41) + (rtc.getMonth() * 13) + (rtc.getYear()*3))
          //randNumber = random(6)
          //if (randNumber >= 0 && randNumber <= 0.01)
          //    {
          //    specialMode = 0;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
          //    }
          //else if (randNumber >= 1 && randNumber <= 1.01)
          //    {
          //    specialMode = 1;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
          //    }
          //else if (randNumber >= 2 && randNumber <= 2.01)
          //    {
          //    specialMode = 2;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
          //    }
          //else if (randNumber >= 3 && randNumber <= 3.01)
          //    {
          //    specialMode = 3;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
          //    }
          //else if (randNumber >= 4 && randNumber <= 4.01)
          //    {
          //    specialMode = 4;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
          //    }
          //else if (randNumber >= 5 && randNumber <= 5.01)
          //    {
          //    specialMode = 5;
          //    renderer.clearScreenBuffer(matrix);
          //    renderer.setSpecialMode(specialMode, matrix);
        ...
        if (((rtc.getMinutes() + rtc.getHours()) * 41) % 60 == 0)
        {
          if (rtc.getMinutes() != oldMin) {
            specialMode++;
            if (specialMode > 5)
              specialMode = 0;
            oldMin = rtc.getMinutes();
          }
          renderer.clearScreenBuffer(matrix);
          renderer.setSpecialMode(specialMode, matrix);
        }
...
void setDisplayDarker() {
  if ((!settings.getUseLdr()) && (settings.getBrightness() > 1)) {
    int i = settings.getBrightness() - 0
            ;
    if (i < 2) {
      i = 1;
    }
